        ...
        <tbody>
          {filteredSales.map(s => (
            <tr key={s.id}>
              ...
              <td className="px-4 py-2 text-center w-[120px]">{s.purchased_date}</td>
              ...
              <td className="px-4 py-2 text-center w-[130px]">{(s.purchase_price * s.purchase_amount).toLocaleString()}</td>
